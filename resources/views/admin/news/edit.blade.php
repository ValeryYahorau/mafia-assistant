...
@section('content')
  <div class="admin-content top">
    <div class="head">
      <div class="l">
        <h1>Edit news</h1>
        <p>Please use form below to edit news.</p>
      </div>
      <div class="r"></div>
    </div>  
    <div class="entity-form">
      <div class="l">
        <form action="{{ LaravelLocalization::localizeURL('/admin/update-news') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label>Date</label>
              <input name="date" type="text" id="datepicker" value="{{$news->date}}">
              @if ($errors->has('date'))
            ...
            <div class="form-group">
              ...
              @if ( $news->img_path )
                <div class="preview-block show">
                  <img id="preview" src="{{url('/')}}{{Config::get('noccms.img_path')}}{{$news->img_path}}" />
                </div>
              @else   
