<div class="page-sidebar">
    <ul>
        ...
        @if(!Auth::guest() && Auth::user()->is_admin())
            ...
            <li><a href="{{url('/admin/news')}}"><i class="fa fa-futbol-o" aria-hidden="true"></i> Турниры</a></li>
            <li><a href="{{url('/admin/users')}}"><i class="fa fa-users" aria-hidden="true"></i> Игроки</a></li>
