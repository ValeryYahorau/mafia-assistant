                    ...
                    @foreach( $gameplayers as $index => $gameplayer )
                        @if ($gameplayer->position < 6)
                            <div class="form-group">
                                ...
                                <div class="">{{ $gameplayer->player->name_ru }}/{{ $gameplayer->player->name_en }}</div>
                                @if ($gameplayer->role == "red")
                                    <a href="{{ asset('noc_admin/img/red.jpg') }}" data-fancybox>
                                        Показать роль
                                    </a>
                                @endif
                                @if ($gameplayer->role == "sheriff")
                                    <a href="{{ asset('noc_admin/img/sheriff.jpg') }}" data-fancybox>
                                        Показать роль
                                    </a>
                                @endif
                                @if ($gameplayer->role == "black")
                                    <a href="{{ asset('noc_admin/img/black.jpg') }}" data-fancybox>
                                        Показать роль
                                    </a>
                                @endif
                                @if ($gameplayer->role == "don")
                                    <a href="{{ asset('noc_admin/img/don.jpg') }}" data-fancybox>
                                        Показать роль
                                    </a>
                                @endif
                            </div>
